...
def question3_4():
    ...
    #The interval is there no true zero point which 3 and 5 hours difference.
    answer = ['Continuous', 'Quantitative', 'Ratio and Interval']
    return answer

def question3_5():
    #IP address of a machine.
    answer = ['Discrete', 'Qualitative', 'Norminal']
    return answer
